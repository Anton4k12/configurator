...
export const BottomNavBar = ({ price, subModel }) => {
  ...
  return (
    <div
      ...
      className="fixed bottom-0 left-0 z-40 hidden h-24 w-full items-center justify-between gap-10 bg-white px-10 py-2 shadow-[0_0_8px_rgb(168,168,168,0.5)] lg:flex"
    >
